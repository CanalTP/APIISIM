# Content generated by sqlacodegen with some manual modifications.
...
class BackOfficeImport(Base):
    __tablename__ = 'back_office_import'

    id = Column(Integer, primary_key=True)
    start_date = Column(TIMESTAMP)
    end_date = Column(TIMESTAMP)
    result = Column(Enum(u'success', u'fail', name='import_result_enum'))
    nb_stops = Column(Integer)
    nb_new_stops = Column(Integer)
    nb_updated_stops = Column(Integer)
    nb_deleted_stops = Column(Integer)
    nb_transfers = Column(Integer)
    nb_new_transfers = Column(Integer)
    nb_updated_transfers = Column(Integer)
    nb_deleted_transfers = Column(Integer)
    nb_mis_connections = Column(Integer)
    nb_new_mis_connections = Column(Integer)
    nb_deleted_mis_connections = Column(Integer)
